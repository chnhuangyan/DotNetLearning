...
namespace AngularDotNetCore.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AngularDotNetCoreDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AngularDotNetCoreEfCoreEntityExtensionMappings to extend the IdentityUser entity
